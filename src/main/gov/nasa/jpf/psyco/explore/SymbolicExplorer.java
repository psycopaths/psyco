...
public abstract class SymbolicExplorer {
  ...
  // method to get the constraints tree
  public abstract ConstraintsTree getConstraintsTree(String methodName);

  // checks if a given constraints tree has an error path
  public abstract boolean inError(ConstraintsTree T) ;
}
